...
class ScannerSubscription(object):
    ...
    m_moodyRatingAbove = None
    m_moodyRatingBelow = None
    m_spRatingAbove = None
    m_spRatingBelow = None
    m_maturityDateAbove = None
    m_maturityDateBelow = None
    m_couponRateAbove = Double.MAX_VALUE
    m_couponRateBelow = Double.MAX_VALUE
    m_excludeConvertible = None
    m_scannerSettingPairs = None
    m_stockTypeFilter = None
