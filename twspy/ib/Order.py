...
from ..lang.java import Double, Integer, Vector
...
class Order(object):
    ...
    m_activeStartTime = None

    #  GTC orders
    m_activeStopTime = None
    ...
    #  specify the percentage, e.g. 3, not .03
    ...
    m_deltaNeutralOpenClose = None
    m_deltaNeutralShortSale = bool()
    m_deltaNeutralShortSaleSlot = int()
    m_deltaNeutralDesignatedLocation = None

    #  COMBO ORDERS ONLY
    m_basisPoints = float()

    #  EFP orders only, download only
