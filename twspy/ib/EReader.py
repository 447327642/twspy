...
class EReader(Thread):
    ...
    @__init__.register(object, str, object, object)
    ...
    def processMsg(self, msgId):
        ...
        if msgId == self.TICK_PRICE:
            ...
            if version >= 29:
                ...
                if comboLegsCount > 0:
                    contract.m_comboLegs = Vector(comboLegsCount)
                    i = 0
                ...
                if orderComboLegsCount > 0:
                    order.m_orderComboLegs = Vector(orderComboLegsCount)
                    i = 0
            ...
            if version >= 26:
                ...
                if smartComboRoutingParamsCount > 0:
                    order.m_smartComboRoutingParams = Vector(smartComboRoutingParamsCount)
                    i = 0
            ...
            if version >= 7:
                ...
                if secIdListCount > 0:
                    contract.m_secIdList = Vector(secIdListCount)
                    i = 0
